	...
	public class Selector : MonoBehaviour {
		...
		private void Run2DRaycast() {
			if (raycastAll) {
				...
				RaycastHit2D[] hits;
				hits = Physics2D.RaycastAll(Camera.main.ScreenToWorldPoint(GetSelectionPoint()), Vector2.zero, maxSelectionDistance, layerMask);
				...
				RaycastHit2D hit;
				hit = Physics2D.Raycast(Camera.main.ScreenToWorldPoint(GetSelectionPoint()), Vector2.zero, maxSelectionDistance, layerMask);
